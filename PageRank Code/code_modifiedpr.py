...
#Temporal Betweenness centarlity values
...
#Calculation of total path flows
...
#Applying the modified formula for PageRank 
iklist=[]
...
print("Rank between modified PageRank and Temporal Betweenness Centrality = %.8f" % (coeff*100))
...
print("Rank between Static PageRank and temporal betweenness centrality = %.8f" % (coeff*100))

coeff,p = kendalltau(list1,list3)
print("Rank between static PageRank and modified PageRank = %.8f" % (coeff*100))
...
plt.title("Rank coeff percentage(Temporal BWC and Pr(k)) v/s iteration")
plt.show()
...
print("Rank between Temporal PageRank and modified PageRank  = %.8f" % (coeff*100))

coeff,p = kendalltau(list2,list4)
print("Rank between Temporal PageRank and Temopral betweenness centrality  = %.8f" % (coeff*100))